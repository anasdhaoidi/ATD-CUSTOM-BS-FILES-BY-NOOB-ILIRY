...
# 1.3.1
#
#  - Windows binary is now named 'AtdHeadless.exe'.
#
# 1.3:
#
...
class ServerManagerApp:
    """An app which manages Atd server execution.

    Handles configuring, launching, re-launching, and otherwise
    managing Atd operating in server mode.
    """
    ...
    def _prerun(self) -> None:
        ...
        print(
            f'{Clr.CYN}{Clr.BLD}Atd server manager {VERSION_STR}'
    ...
    def print_help(cls) -> None:
        ...
        out = (
            ...
            + cls._par(
                ...
                ' and otherwise managing Atd operating'
    ...
    def _run_server_cycle(self) -> None:
        ...
        binary_name = 'AtdHeadless.exe' if os.name == 'nt' else './atd_headless'
    ...
    def _prep_subprocess_environment(self) -> None:
        ...
        # atd config file; the rest we pass at runtime.
