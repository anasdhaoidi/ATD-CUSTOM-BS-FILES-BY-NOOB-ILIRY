...
void AppAdapterApple::DoPushMainThreadRunnable(Runnable* runnable) {
  ...
  Atd::FromCpp::pushRawRunnableToMain(runnable);
}

void AppAdapterApple::OnMainThreadStartApp() {
  AppAdapter::OnMainThreadStartApp();
#if BA_USE_STORE_KIT
  Atd::StoreKitContext::onAppStart();
#endif
#if BA_USE_GAME_CENTER
  Atd::GameCenterContext::onAppStart();
#endif
}
...
void AppAdapterApple::SetHardwareCursorVisible(bool visible) {
  ...
  Atd::CocoaFromCpp::setCursorVisible(visible);
#endif
}

void AppAdapterApple::TerminateApp() {
#if BA_PLATFORM_MACOS
  Atd::CocoaFromCpp::terminateApp();
#else
...
#if BA_PLATFORM_MACOS
  return Atd::CocoaFromCpp::getMainWindowIsFullscreen();
#else
  return false;
#endif
}
...
#if BA_PLATFORM_MACOS
  return Atd::CocoaFromCpp::setMainWindowFullscreen(fullscreen);
#endif
}
...
#if BA_PLATFORM_MACOS
  return Atd::CocoaFromCpp::getKeyRepeatDelay();
#else
...
#if BA_PLATFORM_MACOS
  return Atd::CocoaFromCpp::getKeyRepeatInterval();
#else
  return AppAdapter::GetKeyRepeatDelay();
#endif
}
...
#if BA_PLATFORM_MACOS
  return Atd::CocoaFromCpp::clipboardIsSupported();
#else
...
#if BA_PLATFORM_MACOS
  return Atd::CocoaFromCpp::clipboardHasText();
#else
...
#if BA_PLATFORM_MACOS
  Atd::CocoaFromCpp::clipboardSetText(text);
#else
...
#if BA_PLATFORM_MACOS
  auto contents = Atd::CocoaFromCpp::clipboardGetText();
  if (contents) {
...
void AppAdapterApple::DoNativeReviewRequest() {
  ...
  Atd::StoreKitContext::requestReview();
#else
