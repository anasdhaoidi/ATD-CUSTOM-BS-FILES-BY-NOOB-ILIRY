...
def get_master_asset_src_dir() -> None:
    ...
    master_assets_dir = '/Users/ericf/Documents/atd_master_assets'
...
def logcat() -> None:
    ...
    # else:
    format_args = '-v color '
    cmd = f'{adb} logcat {format_args}Atd:V CrashAnrDetector:V \'*:S\''
...
def efro_gradle() -> None:
    ...
    buildfilename = 'Atd/build.gradle'
