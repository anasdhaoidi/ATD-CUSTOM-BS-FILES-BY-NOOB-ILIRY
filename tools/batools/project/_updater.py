...
class ProjectUpdater:
    ...
    def _update_xcode_projects(self) -> None:
        ...
        for projpath in ['atd-xcode/Atd.xcodeproj/project.pbxproj']:
    ...
    def _update_visual_studio_project(self, basename: str) -> None:
        fname = f'atd-windows/{basename}/' f'Atd{basename}.vcxproj'
    ...
    def _update_cmake_files(self) -> None:
        ...
        self.enqueue_update('atd-cmake/CMakeLists.txt')

        # Our Android cmake build (Currently not included in public).
        fname = 'atd-android/Atd/src/main/cpp/CMakeLists.txt'
        if not self.public:
            self.enqueue_update(fname)
        else:
