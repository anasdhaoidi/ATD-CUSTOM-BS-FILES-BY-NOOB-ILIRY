...
ENV_REQS_SAFE = .cache/checkenv $(PCOMMANDBATCHBIN) .dir-locals.el .rgignore	\
 ...
 atd-cmake/.clang-format .editorconfig tools/cloudshell							\
...
RUN_PREFAB_MAC_X86_64_GUI_RELEASE = cd \
  build/prefab/full/mac_x86_64_gui/release && ./atd
...
prefab-mac-arm64-gui-release-build: env assets-cmake \
   build/prefab/full/mac_arm64_gui/release/atd
	@$(STAGE_BUILD) -cmake -release build/prefab/full/mac_arm64_gui/release

build/prefab/full/mac_%_gui/release/atd: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_MAC_X86_64_SERVER_DEBUG = cd \
 build/prefab/full/mac_x86_64_server/debug && ./atd_server

RUN_PREFAB_MAC_ARM64_SERVER_DEBUG = cd \
 build/prefab/full/mac_arm64_server/debug && ./atd_server
...
prefab-mac-x86-64-server-debug-build: env assets-server \
   build/prefab/full/mac_x86_64_server/debug/dist/atd_headless
...
prefab-mac-arm64-server-debug-build: env assets-server \
   build/prefab/full/mac_arm64_server/debug/dist/atd_headless
	@$(STAGE_BUILD) -cmakeserver -debug build/prefab/full/mac_arm64_server/debug

build/prefab/full/mac_%_server/debug/dist/atd_headless: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_MAC_X86_64_SERVER_RELEASE = cd \
 build/prefab/full/mac_x86_64_server/release && ./atd_server

RUN_PREFAB_MAC_ARM64_SERVER_RELEASE = cd \
   build/prefab/full/mac_arm64_server/release && ./atd_server
...
prefab-mac-x86-64-server-release-build: env assets-server \
   build/prefab/full/mac_x86_64_server/release/dist/atd_headless
...
prefab-mac-arm64-server-release-build: env assets-server \
   build/prefab/full/mac_arm64_server/release/dist/atd_headless
	@$(STAGE_BUILD) -cmakeserver -release \
      build/prefab/full/mac_arm64_server/release

build/prefab/full/mac_%_server/release/dist/atd_headless: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_LINUX_X86_64_GUI_DEBUG = cd \
  build/prefab/full/linux_x86_64_gui/debug && ./atd

RUN_PREFAB_LINUX_ARM64_GUI_DEBUG = cd \
  build/prefab/full/linux_arm64_gui/debug && ./atd
...
build/prefab/full/linux_%_gui/debug/atd: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_LINUX_X86_64_GUI_RELEASE = cd \
  build/prefab/full/linux_x86_64_gui/release && ./atd

RUN_PREFAB_LINUX_ARM64_GUI_RELEASE = cd \
  build/prefab/full/linux_arm64_gui/release && ./atd
...
build/prefab/full/linux_%_gui/release/atd: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_LINUX_X86_64_SERVER_DEBUG = cd \
   build/prefab/full/linux_x86_64_server/debug && ./atd_server

RUN_PREFAB_LINUX_ARM64_SERVER_DEBUG = cd \
   build/prefab/full/linux_arm64_server/debug && ./atd_server
...
prefab-linux-x86-64-server-debug-build: env assets-server \
   build/prefab/full/linux_x86_64_server/debug/dist/atd_headless
	@$(STAGE_BUILD) -cmakeserver -debug \
      build/prefab/full/linux_x86_64_server/debug

prefab-linux-arm64-server-debug-build: env assets-server \
   build/prefab/full/linux_arm64_server/debug/dist/atd_headless
	@$(STAGE_BUILD) -cmakeserver -debug \
      build/prefab/full/linux_arm64_server/debug

build/prefab/full/linux_%_server/debug/dist/atd_headless: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_LINUX_X86_64_SERVER_RELEASE = cd \
   build/prefab/full/linux_x86_64_server/release && ./atd_server

RUN_PREFAB_LINUX_ARM64_SERVER_RELEASE = cd \
   build/prefab/full/linux_arm64_server/release && ./atd_server
...
prefab-linux-x86-64-server-release-build: env assets-server \
   build/prefab/full/linux_x86_64_server/release/dist/atd_headless
	@$(STAGE_BUILD) -cmakeserver -release \
      build/prefab/full/linux_x86_64_server/release

prefab-linux-arm64-server-release-build: env assets-server \
   build/prefab/full/linux_arm64_server/release/dist/atd_headless
	@$(STAGE_BUILD) -cmakeserver -release \
      build/prefab/full/linux_arm64_server/release

build/prefab/full/linux_%_server/release/dist/atd_headless: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_WINDOWS_X86_64_GUI_DEBUG = cd \
 build/prefab/full/windows_x86_64_gui/debug && ./Atd.exe
...
build/prefab/full/windows_x86_64_gui/debug/Atd.exe: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Debug_%/AtdGenericPlus.lib: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Debug_%/AtdGenericPlus.pdb: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

# Windows gui release:

RUN_PREFAB_WINDOWS_X86_64_GUI_RELEASE = cd \
  build/prefab/full/windows_x86_64_gui/release && ./Atd.exe
...
build/prefab/full/windows_x86_64_gui/release/Atd.exe: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Release_%/AtdGenericPlus.lib: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Release_%/AtdGenericPlus.pdb: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_WINDOWS_X86_64_SERVER_DEBUG = cd \
   ...
   && dist/python_d.exe atd_server.py
...
prefab-windows-x86-64-server-debug-build: env \
   assets-windows-$(WINPREVSP) \
   build/prefab/full/windows_x86_64_server/debug/dist/AtdHeadless.exe
	@$(STAGE_BUILD) -winserver-$(WINPREVSP) -debug \
      build/prefab/full/windows_x86_64_server/debug

build/prefab/full/windows_x86_64_server/debug/dist/AtdHeadless.exe: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Debug_%/AtdHeadlessPlus.lib: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Debug_%/AtdHeadlessPlus.pdb: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
RUN_PREFAB_WINDOWS_X86_64_SERVER_RELEASE = cd \
   ...
   && dist/python.exe -O atd_server.py
...
prefab-windows-x86-64-server-release-build: env \
   assets-windows-$(WINPREVSP) \
 build/prefab/full/windows_x86_64_server/release/dist/AtdHeadless.exe
	@$(STAGE_BUILD) -winserver-$(WINPREVSP) -release \
      build/prefab/full/windows_x86_64_server/release

build/prefab/full/windows_x86_64_server/release/dist/AtdHeadless.exe: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Release_%/AtdHeadlessPlus.lib: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@

build/prefab/lib/windows/Release_%/AtdHeadlessPlus.pdb: .efrocachemap
	@$(PCOMMANDBATCH) efrocache_get $@
...
windows-debug: windows-debug-build
	...
	cd build/windows/Debug_$(WINPREVSP) && ./AtdGeneric.exe

# Build and run a release windows build (from WSL).
windows-release: windows-release-build
	@$(WSLW) $(PCOMMAND) ensure_prefab_platform $(WINPREPLT)
	cd build/windows/Release_$(WINPREVSP) && ./AtdGeneric.exe

# Build a debug windows build (from WSL).
windows-debug-build: env \
   build/prefab/lib/windows/Debug_$(WINPREVSP)/AtdGenericPlus.lib \
   build/prefab/lib/windows/Debug_$(WINPREVSP)/AtdGenericPlus.pdb
	@$(WSLW) $(PCOMMAND) ensure_prefab_platform $(WINPREPLT)
...
windows-release-build: env \
   build/prefab/lib/windows/Release_$(WINPREVSP)/AtdGenericPlus.lib \
   build/prefab/lib/windows/Release_$(WINPREVSP)/AtdGenericPlus.pdb
	@$(WSLW) $(PCOMMAND) ensure_prefab_platform $(WINPREPLT)
	@$(PCOMMAND) wsl_build_check_win_drive
...
cmake: cmake-build
	cd build/cmake/$(CM_BT_LC)/staged && ./atd
...
cmake-gdb: cmake-build
	cd build/cmake/$(CM_BT_LC)/staged && \
      BA_DEBUGGER_ATTACHED=1 gdb ./atd
...
cmake-lldb: cmake-build
	cd build/cmake/$(CM_BT_LC)/staged && \
      BA_DEBUGGER_ATTACHED=1 lldb ./atd
...
cmake-binary: meta
	...
	@cd build/cmake/$(CM_BT_LC) && test -f Makefile \
      || cmake -DCMAKE_BUILD_TYPE=$(CMAKE_BUILD_TYPE) $(CMAKE_EXTRA_ARGS) $(shell pwd)/atd-cmake
	@tools/pcommand update_cmake_prefab_lib standard $(CM_BT_LC) \
      build/cmake/$(CM_BT_LC)
	@cd build/cmake/$(CM_BT_LC) && $(MAKE) -j$(CPUS) atdbin

cmake-clean:
	rm -rf build/cmake/$(CM_BT_LC)

cmake-server: cmake-server-build
	cd build/cmake/server-$(CM_BT_LC)/staged && ./atd_server
...
cmake-server-binary: meta
	...
	@cd build/cmake/server-$(CM_BT_LC) && test -f Makefile \
      || cmake -DCMAKE_BUILD_TYPE=$(CMAKE_BUILD_TYPE) $(CMAKE_EXTRA_ARGS) -DHEADLESS=true $(shell pwd)/atd-cmake
	@tools/pcommand update_cmake_prefab_lib server $(CM_BT_LC) \
      build/cmake/server-$(CM_BT_LC)
	@cd build/cmake/server-$(CM_BT_LC) && $(MAKE) -j$(CPUS) atdbin
...
cmake-modular: cmake-modular-build
	cd build/cmake/modular-$(CM_BT_LC)/staged && ./atd
...
cmake-modular-binary: meta
	...
	@cd build/cmake/modular-$(CM_BT_LC) && $(MAKE) -j$(CPUS) atdso

cmake-modular-clean:
	rm -rf build/cmake/modular-$(CM_BT_LC)

cmake-modular-server: cmake-modular-server-build
	cd build/cmake/modular-server-$(CM_BT_LC)/staged && ./atd_server
...
atd-cmake/.clang-format: .clang-format
	@mkdir -p atd-cmake
	@cd atd-cmake && ln -sf ../.clang-format .
...
_windows-wsl-build: env
   ...
   atd-windows/$(WINPRJ)/Atd$(WINPRJ).vcxproj) \
   -target:Build \
   -property:Configuration=$(WINCFG) \
   -property:Platform=$(WINPLT) \
   $(VISUAL_STUDIO_VERSION)
	@$(PCOMMAND) echo BLU BLD Built build/windows/Atd$(WINPRJ).exe.
